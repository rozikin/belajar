...
const actions = [
    ...
    { id: 2, label: "Transaction", route: "/users/transactions" },
    ...
    return (
        <>
            <div className='flex flex-col justify-center items-center w-fit relative z-30'>
                ...
                <div className={`flex flex-col bg-sky-100 w-48 my-2 rounded-lg ${open ? "opacity-100 h-auto" : "opacity-0 h-0"} transition-all duration-200 overflow-hidden absolute top-12 right-0`}>
